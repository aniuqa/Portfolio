...
<body>
    ...
    <div class="container">
        ...
        <section>
            <h2>The Evolution: From Mobile Hustle to Rig</h2>
            <div class="specs-box">
                <p>Proving that exceptional work comes from understanding psychology and composition, not expensive enterprise software. Every asset shown here was handcrafted without AI automation.</p>
                <div class="specs-grid">
                    <div class="spec-item">
                        <h4>📱 The Origin Era (Mobile Only)</h4>
                        <p style="font-size: 0.9rem;"><strong>Device:</strong> iPhone 11<br><strong>Tools:</strong> Pixelmator (Thumbnails), Mobile Editing Suites<br><strong>Reality:</strong> Zero budget for Photoshop, zero AI shortcuts—just raw human design execution.</p>
                    </div>
                    <div class="spec-item">
                        <h4>💻 The Current Setup</h4>
                        <p style="font-size: 0.9rem;"><strong>CPU:</strong> AMD Ryzen 5 5600G<br><strong>GPU:</strong> GTX 1060 3GB | <strong>RAM:</strong> 16GB 3600MHz<br><strong>Storage:</strong> 1TB SSD<br><em>Armed with a proper rig to scale up output and speed.</em></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="case-study">
                ...
                <p style="margin-top: 12px;">Built entirely on a mobile phone at age 14. This video became a primary traffic engine. The packaging relied on high-contrast subject isolation and clear mobile-scale readability—crafted completely in Pixelmator out of sheer necessity.</p>
            </div>
        </section>

        <section>
            <h2>THUMBNAIL EVOLUTION</h2>
            <p>A look at how visual execution matured from mobile experiments to intentional design systems.</p>
            <div class="timeline-grid">
                <div class="timeline-card" onclick="openModalFromSrc('old6.jpg', event)">
                    <img src="old6.jpg" alt="2019" loading="lazy">
                    <div class="timeline-year">2019 (Early)</div>
                </div>
                <div class="timeline-card" onclick="openModalFromSrc('thumbnail_42.jpg', event)">
                    <img src="thumbnail_42.jpg" alt="2020" loading="lazy">
                    <div class="timeline-year">2020 (Growth)</div>
                </div>
                <div class="timeline-card" onclick="openModalFromSrc('thumbnail_28.jpg', event)">
                    <img src="thumbnail_28.jpg" alt="2021" loading="lazy">
                    <div class="timeline-year">2021 (Refinement)</div>
                </div>
                <div class="timeline-card" onclick="openModalFromSrc('thumbnail_101.jpg', event)">
                    <img src="thumbnail_101.jpg" alt="2022" loading="lazy">
